...
import { IncrementDecrementContext } from "./EVALParser.js";
...
export class EVALParserListener implements ParseTreeListener {
     ...
     * @param ctx the parse tree
     */
    enterIncrementDecrement?: (ctx: IncrementDecrementContext) => void;
    /**
     * Exit a parse tree produced by `EVALParser.incrementDecrement`.
     * @param ctx the parse tree
     */
    exitIncrementDecrement?: (ctx: IncrementDecrementContext) => void;
    /**
